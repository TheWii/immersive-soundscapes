...
execute if score @s twis.loc matches 1 if score #time twis.data matches 1 run playsound thewii:immersive.ambient.surface.forest.night_addition ambient @s ~ ~ ~ 0.3 1
