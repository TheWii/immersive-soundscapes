...
## RIVER
execute if score @s twis.outside matches 1 if predicate immersive:height/river_height if predicate immersive:biome/on_river run scoreboard players set @s twis.backgr 1
execute if score @s twis.outside matches 1 if predicate immersive:height/river_height positioned ~5 ~ ~ if predicate immersive:biome/on_river run scoreboard players set @s twis.backgr 1
execute if score @s twis.outside matches 1 if predicate immersive:height/river_height positioned ~-5 ~ ~ if predicate immersive:biome/on_river run scoreboard players set @s twis.backgr 1
execute if score @s twis.outside matches 1 if predicate immersive:height/river_height positioned ~ ~ ~5 if predicate immersive:biome/on_river run scoreboard players set @s twis.backgr 1
execute if score @s twis.outside matches 1 if predicate immersive:height/river_height positioned ~ ~ ~-5 if predicate immersive:biome/on_river run scoreboard players set @s twis.backgr 1
