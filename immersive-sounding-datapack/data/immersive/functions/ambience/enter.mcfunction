execute if score @s twis.enter matches 1 run function immersive:ambience/enter_sound
execute if score @s twis.enter matches 3 run function immersive:ambience/enter_sound
