...
execute if score @s twis.trans matches 1 run function immersive:ambience/transition_sound
execute if score @s twis.trans matches 4 run function immersive:ambience/transition_sound
